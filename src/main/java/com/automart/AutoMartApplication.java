        ...
        return args -> {
            ...
            if (userRepository.count() == 0) {
                ...
                Car car1 = new Car(
                        ...
                        "Hybrid",
                        "Automatic",
                        "https://images.unsplash.com/photo-1621007947382-bb3c3994e3fd?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                        4
                );
                ...
                // REVIEWS
                PublicReview review1 = new PublicReview(
                        "Great car, runs smooth!",
                        5,
                        car1,
                        customer
                );
                ...
                // SPARE PARTS
                EnginePart part1 = new EnginePart(
                        "Spark Plugs (Set of 4)",
                        "NGK",
                        8500,
                        "High performance iridium spark plugs.",
                ...
                BodyPart part2 = new BodyPart(
                        ...
                        "OEM",
                        45000,
                        "Original front bumper for Toyota Corolla.",
                ...
                TyrePart part3 = new TyrePart(
                        "All-Season Radial Tyre",
                        "Michelin",
                        28000,
                        "Premium grip and comfort all-season radial tyre.",
                        "https://images.unsplash.com/photo-1578844251758-2f71da64c96f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
                        16,
                        "Universal 15-inch rims",
                        "24 Months"
                );

                ToolPart part4 = new ToolPart(
                        "Mechanic Wrench Toolkit",
                        "Stanley",
                        14500,
                        "Complete 45-piece chrome vanadium socket wrench kit.",
