    ...
    public CommandLineRunner loadData(UserRepository userRepository, VehicleRepository vehicleRepository, SparePartRepository sparePartRepository, ReviewRepository reviewRepository) {
        return args -> {
            if (userRepository.count() == 0) {
                ...
                // Add Spare Parts
                EnginePart part1 = new EnginePart("Spark Plugs (Set of 4)", "NGK", 8500, "High performance iridium spark plugs.", "https://images.unsplash.com/photo-1625047509168-a7026f36de04?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", "Toyota/Honda");
                BodyPart part2 = new BodyPart("Front Bumper", "OEM", 45000, "Original front bumper for Toyota Corolla.", "https://images.unsplash.com/photo-1600705436605-82e7b51bc5e9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", "White");
